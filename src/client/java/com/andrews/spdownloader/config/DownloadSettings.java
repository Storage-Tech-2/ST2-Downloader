...
public class DownloadSettings {
	private static final String CONFIG_FILE = "share-projects-downloader-settings.json";
	private static final Gson GSON = new GsonBuilder().setPrettyPrinting().create();
	private static final String KEY_JOINED_DISCORD_SERVERS = "joinedDiscordServers";
	private static final String KEY_SHARE_PROJECTS_WARNING_ACK = "shareProjectsWarningAcknowledged";
	...
	private void applyDefaults() {
		...
		setDefault(KEY_SHARE_PROJECTS_WARNING_ACK, false);
	...
	public boolean hasAcknowledgedShareProjectsWarning() {
		return config.has(KEY_SHARE_PROJECTS_WARNING_ACK) && config.get(KEY_SHARE_PROJECTS_WARNING_ACK).getAsBoolean();
	}

	public void setAcknowledgedShareProjectsWarning(boolean acknowledged) {
		set(KEY_SHARE_PROJECTS_WARNING_ACK, acknowledged);
	}
